...
let ordinaryList = document.querySelector(".list");

function renderPokemon(film) {
    ordinaryList.innerHTML = null
    for (let i = 0; i < pokemons.length; i++) {
        ...
        for (let j = 0; j < 1; j++) {
            ...
            listImg.src = pokemons[i].img;
            listItem.appendChild(listImg);

            let listName = document.createElement("h3");
            listName.textContent = pokemons[i].name;
            listItem.appendChild(listName);

            let listType = document.createElement("p");
            listType.textContent = pokemons[i].type;
            listItem.appendChild(listType);

            let listHeight = document.createElement("p");
            listHeight.textContent = pokemons[i].height;
            listItem.appendChild(listHeight);

            let listWeight = document.createElement("p");
            listWeight.textContent = pokemons[i].weight;
            listItem.appendChild(listWeight);
        }
    }
